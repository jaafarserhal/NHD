...
const ComingSoon: React.FC = () => {
    return (
        <div className="coming">
            <div className="coming-col order-2 order-md-1">
                <div className="coming-content">
                    <h1 className="coming-title">Coming soon</h1>
                    <p className="coming-text">Something unexpected is about to happen</p>
                    <form className="coming-form">
                        <input
                            className="coming-form__input"
                            type="email"
                            name="email"
                            placeholder="Enter your email"
                        />
                        <button className="coming-form__btn btn btn-primary btn-hover-secondary">
                            Notify Me
                        </button>
                    </form>
