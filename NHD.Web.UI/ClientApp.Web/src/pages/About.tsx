...
export default function About() {
    ...
    return (
        <>
            ...
            <Header />
            {/* Breadcrumb Section */}
            <div className="breadcrumb breadcrumb-about" style={{
                backgroundImage: `url(${(process.env.REACT_APP_BASE_URL || "")}/uploads/sections/${aboutData?.mainSection[0]?.imageUrl})`, backgroundSize: 'cover', backgroundPosition: 'center center'
            }}>
            ...
            {aboutData?.weLoveDates && <div className="section-padding-03 overflow-hidden">
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-md-6">
                            <div className="section-title-10 justify-content-start text-start align-items-start">
                                ...
                                <h1 className="section-title-10__title">{aboutData?.weLoveDates[0]?.titleEn}</h1>
                        ...
                        <div className="col-md-6">
                            <div className="aboutus-image">
                                <img src={`${(process.env.REACT_APP_BASE_URL || "")}/uploads/sections/${aboutData?.weLoveDates[0]?.imageUrl}`} alt={aboutData?.weLoveDates[0]?.titleEn} />
                            </div>
                        </div>
                    </div>
                </div>
