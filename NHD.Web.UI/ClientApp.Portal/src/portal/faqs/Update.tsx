...
export default function UpdateFaq() {
    ...
    const loadFaq = async () => {
        ...
        try {
            ...
            setErrors([error.message || 'Failed to load faq. Please try again.']);
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await faqService.updateFaq(faqData);
            await loadFaq().then(() => {
                notifySuccess();
            });
    ...
    return (
        <>
            ...
            <Helmet>
                <title>Update Faq - Application</title>
            </Helmet>
            <PageTitleWrapper>
                <PageTitle
                    heading="Update Faq"
                    subHeading="Update an existing faq in your catalog"
