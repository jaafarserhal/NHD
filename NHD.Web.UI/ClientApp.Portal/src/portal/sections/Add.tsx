...
export default function AddSection() {
    ...
    const [form, setForm] = useState<Omit<Section, "id" | "ImageFile">>({
        titleEn: "",
        titleSv: "",
        descriptionEn: "",
        descriptionSv: "",
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await sectionsService.addSection(sectionData);

            navigate(RouterUrls.sectionsList);
            ...
            console.error(error);
            setErrors([error.message || 'Failed to add section. Please try again.']);
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <>
            ...
            <Helmet>
                <title>Add Section - Application</title>
            </Helmet>
            <PageTitleWrapper>
                <PageTitle
                    heading="Add Section"
                    subHeading="Add a new section to your catalog"
