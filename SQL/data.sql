...
(311, 300, '400ml', '400ml', SYSUTCDATETIME(), 1),
 -- Status (400 series)
(400, 400, 'Pending', 'Pending', SYSUTCDATETIME(), 1),
(401, 400, 'Paid', 'Paid', SYSUTCDATETIME(), 1),
(402, 400, 'Shipped', 'Shipped', SYSUTCDATETIME(), 1),
(403, 400, 'Cancelled', 'Cancelled', SYSUTCDATETIME(), 1),
...
(510, 500, 'Shop - Main Section', 'Shop - Main Section', SYSUTCDATETIME(), 1),
(511, 500, 'Our Dates - Main Section', 'Shop - Main Section', SYSUTCDATETIME(), 1),
